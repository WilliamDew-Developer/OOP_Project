...
public class TakeoffFrame {
	...
	//Instantiates a list of radio buttons pulling from the flight class to get specific instances of flight as tickable boxes
	public void initRadioButtons() {
		//these will collect the prerequisits from the takeoff class including the weather conditions and the estimated time or arrival
		//
